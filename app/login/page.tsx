...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground flex items-center justify-center p-6 relative overflow-hidden">
      ...
      <div className={`absolute top-6 left-6 right-6 flex items-center justify-between z-10 transition-all duration-500 ${isVisible ? "opacity-100" : "opacity-0"
        }`}>
        <Link
          href="/"
      ...
      {/* Login Card */}
      <div className={`w-full max-w-md relative z-10 transition-all duration-700 ${isVisible ? "opacity-100 scale-100" : "opacity-0 scale-95"
        }`}>
        {/* Logo */}
        ...
        <form onSubmit={handleSubmit} className="glass-panel rounded-2xl p-8 space-y-6">
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              className={`bg-muted border-border text-foreground placeholder:text-muted-foreground focus:border-primary focus:ring-primary/20 transition-all duration-300 h-12 ${errors.email ? "border-red-500" : ""
                }`}
            />
            {errors.email && (
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              <Input
                ...
                className={`bg-muted border-border text-foreground placeholder:text-muted-foreground focus:border-primary focus:ring-primary/20 transition-all duration-300 h-12 pr-12 ${errors.password ? "border-red-500" : ""
                  }`}
              />
              <button
                type="button"
