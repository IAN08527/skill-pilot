...
export default function SignUpPage() {
  ...
  return (
    <div className="min-h-screen bg-[#0A0F1E] text-white flex overflow-hidden">
      {/* Left Panel - Features */}
      <div className={`hidden lg:flex lg:w-1/2 relative flex-col justify-between p-12 transition-all duration-700 ${
        ...
        <div className="relative z-10 max-w-lg">
          ...
          <div className="space-y-4">
            {features.map((feature, index) => (
              <div 
                key={index}
                className={`flex items-center gap-4 p-4 rounded-xl glass-panel transition-all duration-500 ${
      ...
      <div className={`w-full lg:w-1/2 flex items-center justify-center p-6 lg:p-12 transition-all duration-700 ${
        isVisible ? "opacity-100 translate-x-0" : "opacity-0 translate-x-20"
      }`}>
        <div className="w-full max-w-md">
          ...
          <div className="flex items-center justify-center gap-3 mb-8">
            <div className={`w-10 h-10 rounded-full flex items-center justify-center transition-all duration-300 ${
              currentStep >= 1 ? "bg-[#C6E693] text-[#0A0F1E]" : "bg-white/10 text-white/40"
            }`}>
              {currentStep > 1 ? <CheckCircle className="w-5 h-5" /> : "1"}
            </div>
            <div className={`w-16 h-1 rounded-full transition-all duration-300 ${
              currentStep > 1 ? "bg-[#C6E693]" : "bg-white/10"
            }`} />
            <div className={`w-10 h-10 rounded-full flex items-center justify-center transition-all duration-300 ${
              currentStep >= 2 ? "bg-[#C6E693] text-[#0A0F1E]" : "bg-white/10 text-white/40"
            }`}>
              2
            </div>
          </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <Input
                      ...
                      className={`bg-white/5 border-white/10 text-white placeholder:text-white/40 focus:border-[#C6E693] focus:ring-[#C6E693]/20 h-14 pl-12 transition-all duration-300 ${
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <Input
                      ...
                      className={`bg-white/5 border-white/10 text-white placeholder:text-white/40 focus:border-[#C6E693] focus:ring-[#C6E693]/20 h-14 pl-12 pr-12 transition-all duration-300 ${
